  ...
  return (
    <div className="topics-page page-fade-in">
      ...
      <div className="topics-heading">
        <h1 className="topics-title" style={{ fontFamily: 'var(--font-serif)' }}>{topic.label}</h1>
...
const ICONS = {
  'double-pendulum': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      ...
      <path d="M 24 54 Q 38 44 52 38 Q 44 26 36 20" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.35" />
    </svg>
  ),
  'lorenz-attractor': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <path d="M 20 40 Q 10 25 20 20 Q 30 15 32 25 Q 34 35 44 20 Q 54 5 44 40 Q 38 50 32 35 Q 26 20 20 40" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.7" />
  ...
  'damped-oscillator': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      ...
      <path d="M 8 32 Q 12 12 18 32 Q 24 48 30 32 Q 36 20 42 32 Q 48 38 54 32" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.8" />
      <path d="M 8 32 Q 18 16 32 32 Q 46 42 56 32" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.25" strokeDasharray="3 3" />
  ...
  'newtons-cradle': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      ...
      {[12, 22, 32, 42, 52].map((x, i) => (
        <g key={i}>
          <line x1={x} y1="4" x2={i === 0 ? x - 10 : x} y2={i === 0 ? 40 : 48} stroke="currentColor" strokeWidth="1.2" opacity="0.5" />
          <circle cx={i === 0 ? x - 10 : x} cy={i === 0 ? 46 : 54} r="5" fill="currentColor" opacity={i === 0 ? 1 : 0.55} />
        </g>
      ))}
    </svg>
  ),
  'orbital-gravity': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <ellipse cx="32" cy="32" rx="22" ry="10" stroke="currentColor" strokeWidth="1" opacity="0.3" fill="none" />
      <path d="M 10 32 Q 32 10 54 32 Q 32 54 10 32" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.5" />
  ...
  'atwoods-machine': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      ...
      <circle cx="32" cy="18" r="6" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.8" />
  ...
  'projectile-motion': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <path d="M 8 56 Q 32 16 56 56" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" fill="none" opacity="0.5" />
      <circle cx="32" cy="26" r="5" fill="#fb7185" />
      <path d="M 32 26 L 46 26 L 42 22 M 46 26 L 42 30" stroke="#fb7185" strokeWidth="2" fill="none" />
    </svg>
  ),
  'sph-fluid': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      {[[14,44],[22,36],[30,44],[38,36],[46,44],[18,28],[34,28],[26,52],[42,52],[10,52],[54,52]].map(([x,y],i) => (
        <circle key={i} cx={x} cy={y} r={3.5} fill="currentColor" opacity={0.5 + i*0.04} />
      ))}
      <path d="M 6 56 Q 32 48 58 56" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.4" />
    </svg>
  ),
  'wave-pool': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      {[0, 1, 2, 3].map(i => (
        <ellipse key={i} cx="32" cy="32" rx={6 + i * 9} ry={3 + i * 4}
          stroke="currentColor" strokeWidth="1.2" fill="none" opacity={1 - i * 0.22} />
      ))}
  ...
  'electric-charges': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <path d="M 22 32 Q 32 16 42 32" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.4" />
      <path d="M 22 32 Q 32 48 42 32" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.4" />
      <path d="M 22 32 Q 32 32 42 32" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.4" />
  ...
  'electrostatic-fields': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      ...
      {[20, 32, 44].map((y, i) => (
        [16, 32, 48].map((x, j) => (
          <path key={`${i}-${j}`} d={`M ${x-3} ${y+3} L ${x+3} ${y-3} M ${x} ${y-4} L ${x+4} ${y-4} L ${x+4} ${y}`} stroke="currentColor" strokeWidth="1" opacity="0.3" fill="none" />
        ))
      ))}
      <circle cx="32" cy="32" r="16" stroke="currentColor" strokeWidth="1.5" opacity="0.8" fill="none" />
      <circle cx="32" cy="32" r="4" fill="currentColor" opacity="0.8" />
    </svg>
  ),
  'particle-in-box': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <rect x="8" y="10" width="48" height="44" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.4" />
      <path d="M 12 50 Q 20 20 32 50 Q 44 20 52 50" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.8" />
      <path d="M 12 50 Q 20 35 32 50 Q 44 35 52 50" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.3" strokeDasharray="3 3" />
      <line x1="8" y1="50" x2="56" y2="50" stroke="currentColor" strokeWidth="1" opacity="0.3" />
    </svg>
  ),
  'quantum-harmonic-oscillator': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <path d="M 8 54 Q 16 50 24 42 Q 32 28 40 42 Q 48 50 56 54" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.3" />
      <path d="M 14 48 Q 22 30 32 20 Q 42 30 50 48" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.7" />
      ...
      {[20, 28, 36, 44].map((y, i) => (
        <line key={i} x1="16" x2="48" y1={y} y2={y} stroke="currentColor" strokeWidth="0.5" opacity="0.2" />
      ))}
    </svg>
  ),
  'double-slit': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      ...
      {[20, 26, 32, 38, 44].map((y, i) => (
        <circle key={i} cx="52" cy={y} r={i === 2 ? 3 : i % 2 === 0 ? 2 : 1.5} fill="currentColor" opacity={i === 2 ? 0.9 : 0.4} />
      ))}
  ...
  'hydrogen-orbitals': (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <ellipse cx="32" cy="32" rx="20" ry="8" stroke="currentColor" strokeWidth="1.5" opacity="0.4" transform="rotate(30 32 32)" />
      <ellipse cx="32" cy="32" rx="20" ry="8" stroke="currentColor" strokeWidth="1.5" opacity="0.4" transform="rotate(-30 32 32)" />
      <ellipse cx="32" cy="32" rx="20" ry="8" stroke="currentColor" strokeWidth="1.5" opacity="0.4" transform="rotate(90 32 32)" />
